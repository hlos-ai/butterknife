...
export interface ProxyKernelClient {
    get<T = unknown>(path: string, options?: KernelRequestOpts): Promise<KernelResponse<T>>;
    post<T = unknown>(path: string, body: unknown, options: KernelRequestOpts): Promise<KernelResponse<T>>;
}
